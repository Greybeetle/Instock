...
Desc: 新浪财经-交易日历
https://finance.sina.com.cn/realstock/company/klc_td_sh.txt 此处可以用来更新 calendar.json 文件，注意末尾没有 "," 号
"""
import datetime
import pandas as pd
import requests
...
def tool_trade_date_hist_sina() -> pd.DataFrame:
    """
    利用新浪开放接口爬取交易日历数据，来源：交易日历-历史数据，https://finance.sina.com.cn/realstock/company/klc_td_sh.txt
    :return: 交易日历
